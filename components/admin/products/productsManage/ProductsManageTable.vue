...
const sortingOrderOptions = reactive([
    { text: 'asc', value: 'asc' },
...
let items = shuffle(users);

let sortBy = ref('username');
let sortingOrder = ref('asc');
let sortByEmitted = ref('');
let sortingOrderEmitted = ref('');
let sortedRowsEmitted = reactive([]);
